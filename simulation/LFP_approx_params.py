...
def prep_LFP_approximation(params):
    ...
    networkParameters = dict(
        dt=nest.resolution,  # simulation time resolution (ms)
        tstop=1000.,  # simulation duration (ms)
    ...
    electrodeParameters = dict(
        ...
        z=np.linspace(1000., -200., 16),  # z-coordinates of contacts
