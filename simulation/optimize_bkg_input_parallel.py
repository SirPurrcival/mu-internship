...
###########################################################
## This is currently not used! It might work if          ##
## the objective function is changed similar to how the  ##
## non-parallel optimization script uses it, but         ##
## this is currently no priority                         ##
###########################################################
