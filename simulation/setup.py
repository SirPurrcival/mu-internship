...
def setup():
    ...
    params['connectivity'] = np.array(
        ...
        [[0.656, 0.356, 0.093, 0.068, 0.4644, 0.148, 0    , 0    , 0    , 0.148, 0    , 0    , 0    , 0.148, 0    , 0    , 0    ],  ## L1
         ...
         [0.241, 0.25 , 0.050, 0.05 , 0.05  , 0.351, 0.857, 0.082, 0.47 , 0.026, 0.03 , 0    , 0.03 , 0    , 0    , 0    , 0    ],  ## L4I
         [0    , 0.25 , 0.050, 0.05 , 0.05  , 0.351, 0.02 , 0.35 , 0.028, 0    , 0.03 , 0.03 , 0.03 , 0    , 0    , 0    , 0    ],  ## L4I
    ...
    params['syn_strength'] = np.array(
        ...
        [[1.73  , 0.53, 0.48, 0.57, 0.78, 0.42, 0   , 0   , 0   , 0.42, 0   , 0   , 0   , 0.42, 0   , 0   , 0   ],  ## L1
         ...
         [0     , 0.78, 1.39, 0.69, 0.91, 0.83, 1.29, 0.49, 0.49, 0.63, 1.25, 0.52, 0.91, 0.96, 0   , 0   , 0   ],  ## L4E
         [0     , 0.56, 0.68, 0.42, 0.41, 0.64, 0.68, 0.38, 0.38, 0.73, 0.94, 0.42, 0.41, 0   , 0   , 0   , 0   ],  ## L4I
         [0.39  , 0.3 , 0.5 , 0.15, 0.52, 0.29, 0.5 , 0.15, 0.33, 0.28, 0.45, 0.28, 0.52, 0   , 0   , 0   , 0   ],  ## L4I
         [0     , 0.29, 0.18, 0.32, 0.37, 0.29, 0.18, 0.23, 0.37, 0   , 0.18, 0.33, 0.37, 0   , 0   , 0   , 0   ],  ## L4I
